	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<li class="fieldcontain">
					<span id="subcategories-label" class="property-label"><g:message code="category.subcategories.label" default="Subcategories" /></span>
					
						<g:each in="${categoryInstance.subcategories}" var="s">
						<span class="property-value" aria-labelledby="subcategories-label"><g:link controller="subCategory" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></span>
						</g:each>
