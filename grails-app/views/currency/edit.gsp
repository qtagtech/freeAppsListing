...
<html>
	...
	<body>
		<a href="#edit-currency" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-currency" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:currencyInstance, action:'update']" method="PUT" >
